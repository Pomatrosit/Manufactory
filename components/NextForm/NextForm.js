    ...
    >
       ...
       <div style={{transform:translate}} className={style.formTrack}>
           <div style = {{padding:css.padding || "0"}} className={style.step1}>
               ...
               <p className={style.inputLabel}>Имя</p>
               ...
               <p className={style.inputLabel}>Телефон</p>
                  ...
                  <div className={style.policyCheckbox}>
                       {
                          policy && <svg className="policy-checkbox__inner" width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.23882 7.05748L1.41653 4.223L0 5.63473L4.23387 9.88625L12.7359 1.41779L11.3243 0L4.23882 7.05748Z" fill="#492A64"/>
                          </svg>
                        }
                  </div>
                  <p className={style.policyLabel}>Даю свое согласие на обработку персональных данных согласно <a href="">Политике конфиденциальности</a></p>
               </div>
